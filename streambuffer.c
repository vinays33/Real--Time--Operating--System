...
void Task4(void *data)
{
    ...
    while (1)
    {
        ...
        size_t bytesSent = xStreamBufferSend(StreamBuffer, &Send, sizeof(Send), pdMS_TO_TICKS(100));
...
void Task5(void *data)
{
    ...
    while (1)
    {
        size_t bytesReceived = xStreamBufferReceive(StreamBuffer, &receive, sizeof(receive), portMAX_DELAY);
...
int main(void)
{
    StreamBuffer = xStreamBufferCreate(256, 4);
